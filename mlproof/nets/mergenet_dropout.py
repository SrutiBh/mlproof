...
class MergeNetDropout(CNN):
    ...
    def __init__(self):
        ...
        CNN.__init__(self,
            ...
            # conv2d + pool + dropout
            image_conv1_filter_size=(13,13), image_conv1_num_filters=20,
            ...
            # conv2d + pool + dropout
            prob_conv1_filter_size=(13,13), prob_conv1_num_filters=20,
            ...
            # conv2d + pool + dropout
            binary_conv1_filter_size=(13,13), binary_conv1_num_filters=20,
            ...
            # conv2d + pool + dropout
            border_conv1_filter_size=(13,13), border_conv1_num_filters=20,
